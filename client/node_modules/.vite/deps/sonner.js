  ...
  constructor() {
    ...
    this.promise = (o, t) => {
      ...
      let g = o instanceof Promise ? o : o(), l = s !== void 0, E, P = g.then(async (c) => {
        if (E = ["resolve", c], import_react4.default.isValidElement(c))
          l = false, this.create({ id: s, type: "default", message: c });
        else if (Qt(c) && !c.ok) {
          l = false;
...
var Be = (0, import_react.forwardRef)(function(o, t) {
  ...
  return import_react.default.useEffect(() => T.subscribe((d) => {
    ...
    if (y === "system" && (window.matchMedia && window.matchMedia("(prefers-color-scheme: dark)").matches ? M("dark") : M("light")), typeof window == "undefined")
      return;
