...
var approxEqual = function approxEqual2(a10, b7) {
  return Math.abs(a10 - b7) < 1;
};
...
var Virtualizer = function Virtualizer2(_opts) {
  ...
  this.getFurthestMeasurement = function(measurements, index) {
    ...
    return furthestMeasurements.size === _this.options.lanes ? Array.from(furthestMeasurements.values()).sort(function(a10, b7) {
